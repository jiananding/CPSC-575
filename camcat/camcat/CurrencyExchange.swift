...
class Currency_exchange: UIViewController, UITableViewDataSource, UITableViewDelegate{
    ...
    var init_value = UITextField()
    var converted_value = UILabel()
    ...
    override func viewDidLoad() {
        ...
        init_value.frame = CGRect(x: 300, y: 180, width: 150, height: 50)
        init_value.text = "1.0"
        
        converted_value.frame = CGRect(x: 300, y: 250, width: 150, height: 50)
        converted_value.text = "Result"
